...
?>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Reset System</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" id="cleanLeadFrm">
					<input type="hidden" name="act_type" value="reset_system" />
                  <div class="box-body">
					<div class="row">
                  ...
                  <div class="box-body">
					<div class="row">
						<div class="form-group col-md-12">
						  <p>Please be Careful before Reset the system. It will clear all database system</p>
						</div>
	...
	$("#cleanLeadFrm").validate({
		...
		submitHandler: function() { 
			if(confirm("Do you really want to reset system it will delete all the data?"))
			{
				$.ajax({
					type: "POST",
