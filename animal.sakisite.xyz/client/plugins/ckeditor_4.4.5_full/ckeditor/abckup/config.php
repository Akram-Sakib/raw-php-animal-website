...
$baseUrl = 'http://development.eweblabs.in/fintechjobsindia/plugins/ckeditor_4.4.5_full/ckeditor_images/';
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/fintechjobsindia/plugins/ckeditor_4.4.5_full/ckeditor_images/';
