...
//for website
$baseUrl = '/fintechjobs/demo/plugins/ckeditor_4.4.5_full/ckeditor_images/';
$baseDir = $_SERVER['DOCUMENT_ROOT'].'fintechjobs/demo/plugins/ckeditor_4.4.5_full/ckeditor_images/';
