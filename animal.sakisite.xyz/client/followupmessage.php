      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Followup Messages</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Followup Messages</h3>
				  <div class="pull-right">
					<a class="btn btn-primary btn-sm pull-right" href="add_followupmsgs.php">Add Followup Message</a>
					</div>
                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
						<?php
							$followupMsg = $objAdmin->getFollowupMsgs($uId);
							//print_r($settings);
							$i = 1;
						foreach($followupMsg as $msg)
						{	
						...
						<tr id="row_<?php echo $msg['id'];?>">
							...
							<td><a class="edit_ques" href="add_followupmsgs.php?id=<?php echo $msg['id'];?>" rel="<?php echo $msg['id'];?>" title="Edit"><span class="label label-primary"><i class="fa fa-edit"></i></span></a>&nbsp;&nbsp;<a href="javascript:void(0)" action="0" rel="<?php echo $msg['id'];?>" title="Delete" class="delete"><span class="label label-danger"><i class="fa fa-remove"></i></span></a></td>
	  ...
	  <script type="text/javascript">
			...
			$(document).on('click',".delete",function() {
				...
				if(confirm("Do you really want to delete this?"))
				{
					$.ajax({
						...
						data: 'delId='+did+'&act_type=delete_followup',
						cache: false,
						beforeSend:function() {
		...
		$('.imgUpload').change(function(){ 
			...
			for(var i=0; i<files; i++)
			{
				...
				$.ajax({
					url: "attachment.php?type=msgAttach&flag=followupMsg&mid="+id,
					data: oMyForm,
					processData: false,
					contentType: false,
					type: 'POST',
