...
<!--======================= Main Section Start========================  -->
<section class="main_section blog_main_section">
    <div class="mainsection_bfr_container">
        <div class="container">
            <div class="main_section_aftr_row clearfix">
                <div class="row">
                    <div class="col-md-12 left_main_blog col-sm-12">
                    <div class="row">
                    <!-- Pagination -->
                    <?php
                    $per_page = 6;
              ...
              <div class="my_card my_card_post clearfix">
                <div class="pagination">
                  ...
                  echo "<a href='blog.php'>First Page</a>";

                  for ($i=1; $i <= $total_pages; $i++) { 
                  echo "<a href='blog.php?page=$i'>".$i."</a>";
                    }
                  echo "<a href='blog.php?page=$total_pages'>Last Page</a>";
                  ?>
                </div>
              </div>
              <!-- Pagination -->
